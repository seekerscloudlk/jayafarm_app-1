...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~dashboard-dashboard-module~inc-add-order-add-order-module~inc-order-history-order-history-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppMembersIncOrderHistoryOrderHistoryPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppMembersIncOrderHistoryOrderHistoryRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    OrderHistoryPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppMembersIncOrderHistoryOrderHistoryModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _order_info_order_info_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    OrderHistoryPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppMembersIncOrderHistoryOrderHistoryPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppMembersIncOrderHistoryOrderHistoryPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _order_info_order_info_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    function () {
      ...
      _createClass(OrderHistoryPage, [{
        ...
        value: function getCustOdrInfo() {
          ...
          var url = this.storage.svr_url + "OrderCtrl/getOdrHistoryByCust/" + this.custId;
          this.http.get(url).subscribe(function (history) {
            _this.submitting = false;
            console.log(history);

            if (history) {
              _this.orders = history.orders;
              ...
              _this.isOrderAvail = _this.orders.length > 0 ? true : false;
              _this.outst = history.cust_outst;
            }
    ...
    OrderHistoryPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
...
//# sourceMappingURL=default~dashboard-dashboard-module~inc-add-order-add-order-module~inc-order-history-order-history-module-es5.js.map